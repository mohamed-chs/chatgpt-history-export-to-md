...
- **ChatGPT Exports**: 
    ...
    - **Content Types**: `text`, `multimodal_text`, `code`, `execution_output`, `tether_browsing_display`, `tether_quote`, `reasoning_recap`, `thoughts`.
...
- **References**: See `docs/chatgpt-spec-unofficial-v2.md` for comprehensive ChatGPT export schema (v2, Jan 2026).
